...
const routes: Routes = [
  ...
  { path: 'alain/damasio', component: PuzzleComponent, data : {image : 'horde.jpg', answer: 'Furvent', newRoute: '/blank', tips: '6ème forme du vent'}},
  { path: 'blank', component: PuzzleComponent, data : {image : 'blank.png', answer: 'lookimhidden', newRoute: '/movie/dune', tips: '<body>'}},
  { path: 'movie/dune', component: PuzzleComponent, data : {image : 'dune.png', answer: 'Jodorowsky', newRoute: '/changeme', tips: 'The unreleased movie'}},
